...
public class BannerPagerAdapter extends PagerAdapter {
	...
	private List<ZMList> bannerList;
	private View view;
	// private Handler mHandler;
	private BannerEventClick eventClick;

	public BannerPagerAdapter(Context context, List<ZMList> list, BannerEventClick eventClick) {
	...
	public void setList(List<ZMList> list) {
		if (list != null) {
			this.bannerList = list;
		}
	}
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		imageLoader.displayImage(ZMList.getImageUel(), iv_spread_image, options, null);
		iv_spread_image.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				if (eventClick != null) {
					eventClick.eventClick(ZMList.getIsViedo(), ZMList.getArturl());
				}
