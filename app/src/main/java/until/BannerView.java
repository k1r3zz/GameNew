...
public class BannerView {
	...
	private List<ZMList> infoList = new ArrayList<ZMList>();
	...
	public BannerView(Context context, ViewPager viewPager, ViewGroup pointView, List<ZMList> list, TextView textView) {
	...
	public BannerView(Context context, ViewPager viewPager, ViewGroup pointView, List<ZMList> list, TextView textView, BannerEventClick eventClick) {
		this.mContext = context;
		this.pointView = pointView;
		this.viewPager = viewPager;
		this.titleText = textView;
	...
	public BannerView(Context context, ViewPager viewPager, ViewGroup pointView, List<ZMList> list) {
		this.mContext = context;
		this.pointView = pointView;
		this.viewPager = viewPager;
		this.titleText = null;
	...
	public BannerView(Context context, ViewPager viewPager, ViewGroup pointView, List<ZMList> list, BannerEventClick eventClick) {
		this.mContext = context;
		this.pointView = pointView;
		this.viewPager = viewPager;
		this.titleText = null;
	...
	public void setViewPagerList(List<ZMList> list) {
		this.infoList = list;
		if (infoList.size() == 0) {
			return;
		}
	...
	private void initDate() {
		...
		if (infoList != null && infoList.size() > 0) {
			...
			for (int i = 0; i < points.length; i++) {
				...
				LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(new LayoutParams(dp2px(10), dp2px(10)));
