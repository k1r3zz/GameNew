 ...
 */
public class ZMAdapter extends UltimateViewAdapter<ZMAdapter.MyViewHoler> {
    ...
    public ZMAdapter(Context context, ArrayList<ZMList> datas) {
        this.datas = datas;
...
//    }
    ...
    public void onBindViewHolder(final MyViewHoler holder, int position) {
        ...
        // Log.i("opp","========"+datas.get(21).getName());
        ...
        if (datas.get(position) != null&& holder.Title!=null) {
